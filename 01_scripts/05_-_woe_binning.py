...
df_train = pd.read_parquet(interim_library_path + r'\02_-_df_train.parquet')
df_smot_train = pd.read_parquet(interim_library_path + r'\03_-_df_smot_train.parquet')
df_test = pd.read_parquet(interim_library_path + r'\02_-_df_test.parquet')
df_smot_test = pd.read_parquet(interim_library_path + r'\02_-_df_test.parquet')
...
binned_train_export_path = interim_library_path + r'\04_-_df_train_binned.parquet'
binned_smot_train_export_path = interim_library_path + r'\04_-_df_smot_train_binned.parquet'
binned_test_export_path = interim_library_path + r'\04_-_df_test_binned.parquet'
binned_smot_test_export_path = interim_library_path + r'\04_-_df_smot_test_binned.parquet'
...
del df_train, df_smot_train, df_test, df_smot_test, categorical_variables
del binned_train_export_path, binned_smot_train_export_path, binned_test_export_path
del binned_smot_test_export_path
