...
df_train = pd.read_parquet(interim_library_path + r'\04_-_df_train_binned.parquet')

df_smot_train = pd.read_parquet(interim_library_path + r'\04_-_df_smot_train_binned.parquet')

list(df_smot_train)

df_test = pd.read_parquet(interim_library_path + r'\04_-_df_test_binned.parquet')
df_smot_test = pd.read_parquet(interim_library_path + r'\04_-_df_smot_test_binned.parquet')

df_train_export_path = interim_library_path + r'\06_-_df_train.parquet'
df_test_export_path = interim_library_path + r'\06_-_df_test.parquet'
df_smot_train_export_path = interim_library_path + r'\06_-_df_smot_train.parquet'
df_smot_test_export_path = interim_library_path + r'\06_-_df_smot_test.parquet'
