...
df_smot_train = pd.read_parquet(interim_library_path + r'\01-4_-_df_smot_train.parquet')
df_test = pd.read_parquet(interim_library_path + r'\01-2_-_df_test.parquet')
df_smot_test = pd.read_parquet(interim_library_path + r'\01-2_-_df_test.parquet')

# Keeping note of the categorical variables for the binning procedure.
...
binned_train_export_path = interim_library_path + r'\02-1_-_df_train_binned.parquet'
binned_smot_train_export_path = interim_library_path + r'\02-1_-_df_smot_train_binned.parquet'
binned_test_export_path = interim_library_path + r'\02-1_-_df_test_binned.parquet'
binned_smot_test_export_path = interim_library_path + r'\02-1_-_df_smot_test_binned.parquet'
