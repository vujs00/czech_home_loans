...
df_smot_train_export_path = interim_library_path + r'\03_-_df_smot_train.parquet'

variable_mapping = pd.read_parquet(interim_library_path + r'\01_-_variable_mapping.parquet')
...
smotenc = SMOTENC(categorical_features, random_state = set_seed, k_neighbors = 5)
