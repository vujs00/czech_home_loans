...
df = pd.read_parquet(interim_library_path + r'\01_-_df.parquet')

train_export_path = interim_library_path + r'\02_-_df_train.parquet'
test_export_path = interim_library_path + r'\02_-_df_test.parquet'
