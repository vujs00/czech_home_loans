...
# Obtain spearman correlations to recognize non-monotonical relationships
# Hence, if its not 1 its non-monotonical, obtain a dictionary of variables
# 
...
def bin_and_transform(df_train, df_test, target,
    ...
    # Apply to train.
    X_binned = binning_process.transform(X, metric = feature_transformation_metric)
